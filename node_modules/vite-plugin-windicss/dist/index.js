...
function createBox(_options = {}) {
  ...
  function initWindicss() {
    return new (0, _windicss2.default)(loadConfiguration());
  }
  function getGlobs() {
    const {dirs, fileExtensions, include: include2} = scanOptions;
    const globs2 = dirs.map((i) => slash(_path.join.call(void 0, i, `**/*.{${fileExtensions.join(",")}}`)));
  ...
  async function getFiles() {
    const files2 = await _fastglob2.default.call(void 0, globs, {
      cwd: root,
      ignore: excludeGlobs,
      onlyFiles: true,
      absolute: true
  ...
  async function scan() {
    if (!_searching) {
      _searching = (async () => {
        ...
        const contents = await Promise.all(files.filter((id) => isDetectTarget(id)).map((id) => _fs.promises.readFile(id, "utf-8")));
  ...
  function isExcluded(id) {
    return id.match(/\b(?:node_modules|.git)\b/) || _micromatch2.default.isMatch(slash(_path.relative.call(void 0, root, id)), excludeGlobs);
  }
  ...
  function transformCSS(css) {
    if (!enableCssTransform)
      return css;
    const style2 = new (0, _parser.CSSParser)(css, processor).parse();
    return style2.build();
  }
  let style = new (0, _style.StyleSheet)();
  let _cssCache;
...
exports.createBox = createBox; exports.default = src_default; exports.defaultAlias = defaultAlias; exports.htmlTags = htmlTags; exports.preflightTags = preflightTags;
